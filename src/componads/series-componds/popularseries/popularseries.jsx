...
export default function PopularSeries() {
    ...
    const chunkedseries = [];
    for (let i = 0; i < series.length; i += cardsPerSlide) {
        chunkedseries.push(series.slice(i, i + cardsPerSlide));
    }
    ...
    return (
        <div id="carouselExample6" className="carousel slide now-playing" data-bs-ride="carousel">
            <div className="carousel-inner">
                <div className="top d-flex justify-content-between align-items-center px-5 me-5">
                    <h1 className='text-white mx-5'>Popular series : </h1>
                ...
                {
                    chunkedseries.map((group, seriesIndex) => (
                        <div className={`carousel-item ${seriesIndex === 0 ? 'active' : ''}`} key={seriesIndex}>
                            <div className="top d-flex justify-content-center gap-3 py-4">
                                {
                                    group.map(item => (
                                        <div key={item.id}>
